...
export async function fetchConsultationSlots(params: { specialistKey: string; from: string; days: number }): Promise<ConsultationSlotsResponse> {
...
export async function bookConsultation(body: CreateConsultationBookingBody): Promise<ConsultationBookingResponse> {
...
export async function createConsultationSlots(body: CreateConsultationSlotsBody): Promise<CreateConsultationSlotsResponse> {
...
export async function deleteConsultationSlot(slotId: string): Promise<DeleteConsultationSlotResponse> {
