...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        tiny: ['Mulish', 'var(--anuva-indic)', 'sans-serif'],
        mono: ['"Space Mono"', 'var(--anuva-indic)', 'monospace'],
        script: ['"Dancing Script"', 'var(--anuva-indic)', 'cursive'],
        body: ['Mulish', 'var(--anuva-indic)', 'sans-serif'],
        h1: ['Fraunces', 'var(--anuva-indic)', 'serif'],
        h2: ['Fraunces', 'var(--anuva-indic)', 'serif'],
        small: ['Mulish', 'var(--anuva-indic)', 'sans-serif'],
        h3: ['Fraunces', 'var(--anuva-indic)', 'serif'],
        h4: ['Fraunces', 'var(--anuva-indic)', 'serif'],
      },
      fontSize: {
