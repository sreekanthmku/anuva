 ...
 * possible failure here: a doctor cannot tell a crash from a blank screen mid-consultation, so they wait, then reload,
 * then assume the portal is broken for good. `Sentry.ErrorBoundary` catches it, reports it, and puts
    ...
    <main className="flex min-h-mobile items-center justify-center bg-surface px-6 text-center">
      <div className="w-full max-w-[340px]">
        ...
        <p className="mt-2.5 text-[14px] leading-[1.6] text-on-surface-variant" style={mulish}>
          Nothing you did caused this, and no patient record has been affected. Reloading usually sorts
          it out.
        </p>
