...
const BUFFER_KEY = 'anuva-family-install-events';
const BUFFER_LIMIT = 50;
const FIRST_STANDALONE_KEY = 'anuva-family-first-standalone-seen';
const SESSION_STANDALONE_KEY = 'anuva-family-standalone-session-logged';
