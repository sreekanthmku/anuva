 ...
 * possible failure here: a family member cannot tell a crash from a blank screen, so they wait, then reload,
 * then assume the app is broken for good. `Sentry.ErrorBoundary` catches it, reports it, and puts
